                ...
                <tr>
                    ...
                    <td class="px-3 py-2 border">
                        <div class="flex justify-between items-center">
                            ...
                            <div>
                                <a href="{{route('deleted_data_absen_siswa', $absen->id)}}">
    ...
    <div id="data_absen_siswa" class="md:hidden block overflow-auto h-[650px] p-3">
        @foreach ($data_absen as $absen)
            <div class="w-full rounded-lg bg-white p-1">
                ...
                <div class="flex justify-center items-center">
                    <div>
                        <a href="{{route('deleted_data_absen_siswa', $absen->id)}}" class="py-0.5 px-1.5 text-xs bg-red-400 hover:bg-red-500 rounded">Delete</a>
                    </div>
                    <div class="ml-2">
