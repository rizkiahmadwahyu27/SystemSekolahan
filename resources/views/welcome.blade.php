...
<body class="bg-gray-100 font-sans">
  ...
  <section class="bg-orange-500 text-white py-20 text-center">
    <div class="max-w-3xl mx-auto px-4">
      <h1 class="text-4xl md:text-5xl font-extrabold mb-4">Selamat Datang di Sekolah Kami</h1>
      <p class="text-lg md:text-xl mb-6">Mewujudkan Pendidikan Berkualitas untuk Masa Depan yang Cerah</p>
      <a href="#registrasi" class="bg-white text-orange-500 py-2 px-6 rounded-lg font-semibold hover:bg-orange-200 transition duration-300">Daftar Sekarang</a>
    </div>
  </section>
  ...
  <section id="kontak" class="py-20 bg-orange-500 text-white text-center">
    <div class="max-w-screen-md mx-auto px-4">
      ...
      <a href="mailto:info@sekolah.com" class="bg-white text-orange-500 py-2 px-6 rounded-lg font-semibold hover:bg-orange-200 transition">Kirim Email</a>
    </div>
  </section>
