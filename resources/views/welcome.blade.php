...
<body class="bg-gray-100 font-sans">
  ...
  <section class="bg-orange-500 text-white flex justify-center py-20 text-center bg-cover">
    <div class="max-w-3xl mx-auto px-4">
      ...
      <a href="https://lynk.id/smkpelitajatibarang" target="blank" class="bg-white text-orange-500 py-2 px-6 rounded-lg font-semibold hover:bg-orange-200 transition duration-300">Daftar Sekarang</a>
    </div>
  </section>
