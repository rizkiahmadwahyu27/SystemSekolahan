            ...
            <div class="bg-slate-200 rounded-xl h-28 w-72 md:w-auto">
                <div class="grid grid-cols-4 gap-2 justify-center items-center">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="flex justify-center items-center">
                            <h1 class="text-4xl font-bold text-slate-500">800</h1>
                        </div>
                        <div class="flex justify-center items-center">
            ...
            <div class="bg-slate-200 rounded-xl h-28 w-72 md:w-auto">
                <div class="grid grid-cols-4 gap-2 justify-center items-center">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="flex justify-center items-center">
                            <h1 class="text-4xl font-bold text-slate-500">40</h1>
                        </div>
                        <div class="flex justify-center items-center">
            ...
            <div class="bg-slate-200 rounded-xl h-28 w-72 md:w-auto">
                <div class="grid grid-cols-4 gap-2 justify-center items-center">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="flex justify-center items-center">
                            <h1 class="text-4xl font-bold text-slate-500">12</h1>
                        </div>
                        <div class="flex justify-center items-center">
                            <a href="#" class="bg-slate-500 text-white p-1 rounded-md text-xs">Cek Detail</a>
                        </div>
            ...
            <div class="bg-slate-200 rounded-xl h-28 w-72 md:w-auto">
                <div class="grid grid-cols-4 gap-2 justify-center items-center">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="flex justify-center items-center">
                            <h1 class="text-4xl font-bold text-slate-500">8</h1>
                        </div>
                        <div class="flex justify-center items-center">
                            <a href="#" class="bg-slate-500 text-white p-1 rounded-md text-xs">Cek Detail</a>
                        </div>
