                ...
                <tr>
                    ...
                    <td class="px-3 py-2 border">
                        <div class="flex justify-between items-center">
                            ...
                            <div>
                                <a href="{{route('deleted_data_siswa', $siswa->id)}}">
        ...
        @foreach ($siswas as $siswi)
            <div class="grid grid-cols-5 gap-0 justify-center items-start bg-white rounded-lg p-1 mb-1">
                ...
                <div class="col-span-4">
                    ...
                    <div class="flex justify-center items-center">
                        <div>
                            <a href="{{route('deleted_data_siswa', $siswi->id)}}" class="py-0.5 px-1.5 text-xs bg-red-400 hover:bg-red-500 rounded">Delete</a>
                        </div>
                        <div class="ml-2">
